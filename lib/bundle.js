...
class Game {
  ...
  renderCards(){
    this.deck.forEach(card => $('#board-ul').append(card.domCard) );
...
class Board {
  constructor(amount){
    ...
    this.icons = this.shuffle(
                   [ "fa fa-car", "fa fa-futbol-o", "fa fa-space-shuttle",
                   ...
                   "fa fa-unlock", "fa fa-volume-up", "fa fa-video-camera",
                   "fa fa-thumb-tack", "fa fa-shopping-cart", "fa fa-calculator",
                   "fa fa-commenting", "fa fa-graduation-cap", "fa fa-bed",
                   "fa fa-phone","fa fa-thumbs-o-up", "fa fa-truck","fa fa-subway"])
    this.deck = this.shuffle(this.createDeck(amount));
  }
